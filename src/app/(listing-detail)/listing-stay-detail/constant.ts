...
export const Amenities_demos = [
  ...
  { name: "Xe đẩy hành lý", icon: "la-luggage-cart" },
  { name: "Vòi sen", icon: "la-shower" },
  { name: "Hút thuốc", icon: "la-smoking" },
  { name: "Bông tuyết", icon: "la-snowflake" },
  { name: "Spa", icon: "la-spa" },
  { name: "Vali", icon: "la-suitcase" },
  { name: "Vali kéo", icon: "la-suitcase-rolling" },
  { name: "Hồ bơi", icon: "la-swimmer" },
  // { name: "la-swimming-pool", icon: "la-swimming-pool" },
  { name: "TV", icon: "la-tv" },
  { name: "Dù che", icon: "la-umbrella-beach" },
  { name: "Ăn uống", icon: "la-utensils" },
  { name: "Xe lăn", icon: "la-wheelchair" },
  { name: "Wifi", icon: "la-wifi" },
  { name: "Xe đẩy em bé", icon: "la-baby-carriage" },
  { name: "Bồn tắm", icon: "la-bath" },
  { name: "Giường đôi", icon: "la-bed" },
