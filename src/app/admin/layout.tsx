...
const items = [
  {
    ...
    children: [
      ...
      {
        key: "phan-quyen",
        label: <Link href="/admin/phan-quyen">Phân Quyền</Link>,
      },
      {
        key: "khach-hang",
  ...
  {
    key: "bien-the-nguoi-dung",
    icon: <SolutionOutlined />,
    label: <Link href="/admin/bien-the-nguoi-dung">Biến Thể Người Dùng</Link>,
  },
  {
    key: "quan-ly-tin-tuc",
    icon: <CalendarOutlined />,
    label: <Link href="/admin/quan-ly-tin-tuc">Quản Lý Tin Tức</Link>,
  },
  {
    key: "sub1-2",
    ...
    children: [
      {
        key: "loai-tour",
        label: <Link href="/admin/loai-tour">Quản Lý Loại Tour</Link>,
      },
      { key: "tour", label: <Link href="/admin/tour">Tour</Link> },
      {
        key: "bien-the-tour",
        label: <Link href="/admin/bien-the-tour">Biến Thể Tour</Link>,
      },
      {
        key: "sub2-1",
        ...
        children: [
          {
            key: "dia-diem",
            label: <Link href="/admin/dia-diem">Địa Điểm</Link>,
          },
          {
            key: "lich-trinh-tour",
            label: <Link href="/admin/lich-trinh-tour">Lịch Trình Tour</Link>,
          },
        ],
      },
    ],
  },
  {
    key: "danh-gia",
    icon: <CopyOutlined />,
    label: <Link href="/admin/danh-gia">Quản Lý Đánh Giá</Link>,
  },
  {
    key: "dat-tour",
    icon: <MailOutlined />,
    label: <Link href="/admin/dat-tour">Quản Lý Đặt Tour</Link>,
  },
  {
    key: "thanh-toan",
    icon: <DollarOutlined />,
    label: <Link href="/admin/thanh-toan">Thanh Toán</Link>,
  },
  {
    key: "sub2",
    label: "Thống Kê",
  ...
  return (
    <div className="">
      ...
      <div
        className=""
        style={{
          marginLeft: "200px", // Để không chồng lên sidebar
          marginTop: "120px",
          width: "100%", // Thay vì sử dụng phép tính, sử dụng phần trăm
          padding: "16px", // Thêm padding nếu cần
          boxSizing: "border-box", // Để padding không làm tăng chiều rộng
        }}
      >
        {children}
      </div>
