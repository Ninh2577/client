...
const NguoiSangTao = () => {
  return (
    <div className="nc-SectionFounder relative">
      <Heading
        desc="Chúng tôi là một tổ chức trung lập và độc lập, mỗi ngày chúng tôi tạo ra các chương trình và nội dung độc đáo, đẳng cấp thế giới."
      >
        ⛱ Nhà sáng lập
      </Heading>
